...
namespace oop_lab_5_rpv
{
    public class AdvancedClass : OrdinaryCalc
    {
        public double num1;
        public double num2;
        ...
        public static void AdvaCalc()
        {
            ...
            while (is_work)
            {
                ...
                Console.WriteLine(" |   5. Bytes to kilobytes        | ");
                ...
                else if (choise == 5)
                {
                    ...
                    var byte_num=new AdvancedClass();
                    SetNum1(byte_num);
                    if (GetNum1(byte_num) <= 1 || GetNum1(byte_num) >= Math.Pow(10, 9))
                    {
                    ...
                    {
                        double result = GetNum1(byte_num) * 0.000977;
                        Console.WriteLine(result);
                    }
